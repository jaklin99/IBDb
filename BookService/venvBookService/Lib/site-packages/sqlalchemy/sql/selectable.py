...
class TableClause(roles.DMLTableRole, Immutable, FromClause):
    ...
    the usual set of :class:`_expression.FromClause` crud including
    the ``.c.`` collection and statement generation methods.

    It does **not** provide all the additional schema-level crud
    of :class:`_schema.Table`, including constraints, references to other
    tables, or support for :class:`_schema.MetaData`-level crud.
    It's useful
